<?php
  ...
  header('refresh:3;url=index.php'); // redirection vers l'accueil
?>
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/mdpp.min.css">
  ...
  .perspective
  {
     background: url(assets/images/doorBorder.png);
          ...
          .thumb
          {
              background: url(assets/images/ClassDoor.png);
              background-repeat: no-repeat;
              background-position: center center;
              width: 147px;
              height: 274px;
      ...
      <main class="demo-main mdl-layout__content">
        <div id="element" class="demo-card-wide mdl-card mdl-shadow--2dp  mdl-grid" style="height: 500px">
        	...
        	<div style="padding-top: 80px;margin-left: auto;margin-right: auto;">
              ...
              <div class="thumb thumbOpened"></div>
            </div>
        	</div>
